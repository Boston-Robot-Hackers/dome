...
void loop() {
	...
	//        max_linear.linear_x, max_angular.angular_z, max_linear.linear_x * stopping / max_rpm);
    // }
    // Serial.printf("MOTOR%d %s RPM 1: %8.1f 2: %8.1f 3: %8.1f 4: %8.1f\n",
...
// simply print the current values for the two motor encoders

    Serial.printf("Encoder for Motor 1: %d Motor 2: %d\n", motor1_encoder.read(), motor2_encoder.read());
